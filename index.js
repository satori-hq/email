...
export const sendEmail = async ({
	...
	try {
		...
		// console.log(res)
		return { success: true, id: res.headers['x-message-id'] }
	} catch(e) {
		console.error(e);
	}
...
export const template = ({
	para1, para2, label, link, src, sub1, sub2
}) => {
 return `
<!doctype html>
<html>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ${para1 ? `<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${para1}</p>` : ''}
                        ${para2 ? `<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${para2}</p>` : ''}
                        ...
                        ${sub1 ? `<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${sub1}</p>` : ''}
                        ${sub2 ? `<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${sub2}</p>` : ''}
                      </td>
                    </tr>
                  </table>
                </td>
